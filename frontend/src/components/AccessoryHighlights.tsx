...
const bagProducts: Product[] = [
    ...
    },
    {
        ...
        images: ["https://product.hstatic.net/200000581855/product/_monogram_diamond_embo_mini_backpack_new_york_yankees_3abks051n-50bgd7_b2fd45ff2aee4a50a41c832eb0c543eb_large.png"],
        discountPercent: 13,
...
const hatProducts: Product[] = [
    ...
    },
    {
        ...
        images: ["https://product.hstatic.net/200000581855/product/mu_mlb_diamond_adjustable_new_york_yankees_32cp85111-50q4_36dd3f1ed46c495eb13cf28cd38142dc_large.jpg"],
        discountPercent: 19,
